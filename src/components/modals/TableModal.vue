    ...
    <div class="vi-modal-content">
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <input ref="inputRef" class="vi-input" v-model.number="rows" type="number" min="1" max="20" @keyup.enter="onSubmit" />
        </div>
        <div class="form-group">
          <label>{{ labels.modal.table.cols }}</label>
          <input class="vi-input" v-model.number="cols" type="number" min="1" max="20" @keyup.enter="onSubmit" />
        </div>
      </div>
...
.form-group { margin-bottom: 0.25rem; display: flex; flex-direction: column; flex: 1; }
