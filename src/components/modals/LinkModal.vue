  ...
  <div class="vi-modal-backdrop" @mousedown.self="emit('close')">
    <div class="vi-modal-content">
      ...
      <div class="form-group">
        ...
        <input class="vi-input" v-model="text" type="text" placeholder="..." @keyup.enter="onSubmit" />
      </div>
      <div class="form-group checkbox">
        <label>
          <input v-model="targetBlank" type="checkbox" /> {{ labels.modal.link.newTab }}
        </label>
      </div>
...
.form-group.checkbox { flex-direction: row; align-items: center; margin-top: 0.75rem; margin-bottom: 0; }
.form-group.checkbox label { font-weight: normal; display: flex; align-items: center; gap: 0.5rem; cursor: pointer; }
</style>
