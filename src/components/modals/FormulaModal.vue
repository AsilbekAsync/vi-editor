  ...
  <div class="vi-modal-backdrop" @mousedown.self="emit('close')">
    <div class="vi-modal-content">
      ...
      <div class="form-group">
        ...
        <input ref="inputRef" class="vi-input" v-model="formula" type="text" :placeholder="labels.modal.formula.placeholder" @keyup.enter="onSubmit" />
...
.help-text { font-size: 0.75rem; color: var(--vi-text-light); margin-top: 0.25rem; }
</style>
